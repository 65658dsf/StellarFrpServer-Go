CREATE TABLE
  `users` (
    ...
    `tunnel_count` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '用户当前隧道数量',
    `bandwidth` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '用户带宽限制(Mbps)',
    `traffic_quota` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '用户流量配额(GB)',
    PRIMARY KEY (`id`),
